...
background_image = pygame.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\images\street.png")
...
# background sound
pygame.mixer.music.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\music\back music.wav")
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\images\enemy.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\images\player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\images\gold coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, screen_width - 40), 0)
...
class BigCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\images\red coin.png")
        self.rect = self.image.get_rect()
    def move(self):
        self.rect.move_ip(0, speed)
...
while True:
    ...
    if pygame.sprite.spritecollideany(player, enemies):
        pygame.mixer.Sound(r"C:\Users\PC\Desktop\Python\lab1\LAB9\racer\music\crash.wav").play()
        time.sleep(0.5)
